...
<script type="text/javascript"><!--
	...
	CrosswordHeight = 8;
	Words = 6;
	WordLength = new Array(4, 5, 5, 5, 3, 6);
	Word = new Array();
	Clue = new Array("Pajaro", 
"Caballo", 
"Camello", 
"Tigre", 
"Perro", 
"Mono");
	AnswerHash = new Array(7959, 16988, 76270, 62047, 88368, 40104);
	WordX = new Array(5, 2, 0, 6, 8, 3);
	WordY = new Array(1, 3, 6, 0, 1, 2);
...
function CheckClick()
{
	...
	////////////////////////////////////////////////////////////////////////////////
	//Calclulo de puntos
	puntos=6-ErrorsFound-EmptyFound;
