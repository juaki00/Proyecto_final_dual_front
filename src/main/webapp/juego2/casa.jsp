...
<script type="text/javascript"><!--
	...
	CrosswordHeight = 10;
	Words = 7;
	WordLength = new Array(7, 5, 8, 4, 6, 7, 7);
	Word = new Array();
	Clue = new Array("Balcon", 
"Casa", 
"Pasillo", 
"Entrada", 
"Cuerto de ba�o", 
"Dormitorio", 
"Cocina");
	AnswerHash = new Array(70717, 50468, 9213, 69102, 89036, 28038, 80835);
	WordX = new Array(6, 2, 0, 8, 10, 6, 0);
	WordY = new Array(2, 3, 6, 0, 1, 2, 3);
