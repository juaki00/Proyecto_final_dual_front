...
<script type="text/javascript"><!--
	...
	CrosswordHeight = 16;
	Words = 12;
	WordLength = new Array(5, 7, 4, 5, 4, 8, 3, 8, 6, 8, 9, 7);
	Word = new Array();
	Clue = new Array("Abril", 
"Octubre", 
"Junio", 
"Marzo", 
"Julio", 
...
"Septiembre", 
"Enero");
	AnswerHash = new Array(19733, 30017, 2252, 5639, 12548, 59753, 83406, 25312, 89354, 43443, 83988, 73656);
	WordX = new Array(10, 8, 10, 13, 6, 6, 1, 0, 10, 13, 1, 6);
	WordY = new Array(0, 5, 7, 8, 9, 11, 12, 14, 0, 4, 7, 9);
...
function CheckClick()
{
	...
	////////////////////////////////////////////////////////////////////////////////
	//Calclulo de puntos
	puntos=12-ErrorsFound-EmptyFound;
