...
<div id="waitmessage" class="ecw-answerbox">
    ...
    the page. If this web page is saved on your computer, you may need to click the yellow Information Bar at the top or
    bottom of
...
<table cellpadding="0" cellspacing="0" border="0">
    <tr>
        ...
        <td class="ecw-crosswordarea">
            ...
            <script src="./js/crucigrama1.js"></script>
        ...
        <td valign="top" style="padding-left: 1em;">
            ...
            <div id="answerbox" class="ecw-answerbox" style="display:none;">
                ...
                <div style="margin-top: 1em;">
                    <input class="ecw-input" id="wordentry" type="text" size="24"
                           style="font-weight: bold; text-transform:uppercase;" onkeypress="WordEntryKeyPress(event)"
                ...
                <table border="0" cellspacing="0" cellpadding="0" width="100%" style="margin-top:1em;">
                    ...
                    <tr>
                        <td>
                            <button id="cheatbutton" type="button" class="ecw-input ecw-button" onclick="CheatClick();">
                                Solve
                            </button>
                        </td>
                        <td align="right">
                            <button id="okbutton" type="button" class="ecw-input ecw-button" onclick="OKClick();"
                                    style="font-weight: bold;">OK
                            </button> &nbsp;
                            <button id="cancelbutton" type="button" class="ecw-input ecw-button"
                                    onclick="DeselectCurrentWord();">Cancel
                            </button>
                        </td>
                    </tr>
                    </tbody>
